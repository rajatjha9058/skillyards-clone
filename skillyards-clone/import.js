...
class SkillyardsHeaderLoader {
    ...
    async loadHeaderHTML() {
        ...
        <nav class="bg-white py-3 shadow-md fixed top-0 left-0 right-0 z-50">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <div class="dropdown-parent relative group">
                        ...
                        <div class="dropdown-menu absolute top-full left-0 bg-white shadow-lg rounded-md w-64 py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
                            <a href="Full-Stack Foundation.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">Full-Stack Foundation</a>
                            <a href="Full-Stack Development.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">Full-Stack Development</a>
                            <a href="Front-End Development.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">Front-End Development</a>
                            <a href="Back-End Development.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">Back-End Development</a>
                            <a href="UI-UX Designing Program.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">UI/UX Designing Program</a>
                            <a href="Advanced-Digital-Marketing-Program.html" class="block px-4 py-2 hover:bg-gray-100 transition duration-200">Advanced Digital Marketing Program</a>
                        </div>
                    </div>
...
class SkillyardsFooterLoader {
    ...
    // Create custom CSS styles including new background and glowing border effects
    injectCustomStyles() {
        const style = document.createElement('style');
        style.textContent = `
        .bg-animated {
            background: linear-gradient(-45deg, #000005, #100128, #0a0721);
    ...
    async loadFooterHTML() {
        ...
        <footer class="bg-animated text-white py-16 px-6 relative overflow-hidden mt-10">
            ...
            <p class="text-gray-400 hover:text-white transition-colors">Made by SN Digitech</p>
            <p class="text-gray-400 hover:text-white transition-colors">© 2025 Skillyards. All rights reserved.</p>
        </div>
        </footer>
        `;
